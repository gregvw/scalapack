      SUBROUTINE PZLASCL_I8( TYPE, CFROM, CTO, M, N, A, IA, JA,
     $                       DESCA, INFO )
      IMPLICIT NONE
*
*  -- ScaLAPACK auxiliary routine --
*     INTEGER*8 thin wrapper around PZLASCL.
*
*     .. Scalar Arguments ..
      CHARACTER          TYPE
      INTEGER*8          M, N, IA, JA
...
*
      CALL PZLASCL( TYPE, CFROM, CTO, M4, N4, A, IA4, JA4,
     $              DESCA4, INFO )
*
      RETURN
*
