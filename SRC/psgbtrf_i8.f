      SUBROUTINE PSGBTRF_I8( N, BWL, BWU, A, JA, DESCA, IPIV, AF,
     $                       LAF, WORK, LWORK, INFO )
      IMPLICIT NONE
*
*  -- ScaLAPACK routine --
*     INTEGER*8 thin wrapper around PSGBTRF.
*
...
*     Call legacy routine
*
      CALL PSGBTRF( N4, BWL4, BWU4, A, JA4, DESCA4, IPIV, AF,
