      SUBROUTINE PZDTTRSV_I8( UPLO, TRANS, N, NRHS, DL, D, DU, JA,
     $                        DESCA, B, IB, DESCB, AF, LAF, WORK,
     $                        LWORK, INFO )
      IMPLICIT NONE
*
*  -- ScaLAPACK auxiliary routine --
*     INTEGER*8 thin wrapper around PZDTTRSV.
*
...
*     .. External Subroutines ..
      EXTERNAL           NARROW_DESC8, PZDTTRSV
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          INT
*     ..
...
*     Call legacy routine
*
      CALL PZDTTRSV( UPLO, TRANS, N4, NRHS4, DL, D, DU, JA4,
