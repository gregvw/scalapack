      SUBROUTINE PZGESVD_I8( JOBU, JOBVT, M, N, A, IA, JA, DESCA,
     $                       S, U, IU, JU, DESCU, VT, IVT, JVT,
     $                       DESCVT, WORK, LWORK, RWORK, INFO )
      IMPLICIT NONE
*
*  -- ScaLAPACK routine --
*     INTEGER*8 thin wrapper around PZGESVD.
*
*     .. Scalar Arguments ..
...
*     .. External Subroutines ..
      EXTERNAL           NARROW_DESC8, PZGESVD, PXERBLA
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          INT
*     ..
...
*
     ...
     $    IVT.GT.INTMAX .OR. JVT.GT.INTMAX ) THEN
         INFO = -1
         CALL PXERBLA( ICTXT, 'PZGESVD_I8', -1 )
         RETURN
      END IF
*
      M4   = INT( M )
...
*
      CALL PZGESVD( JOBU, JOBVT, M4, N4, A, IA4, JA4, DESCA4,
