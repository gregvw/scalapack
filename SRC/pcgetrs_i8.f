      SUBROUTINE PCGETRS_I8( TRANS, N, NRHS, A, IA, JA, DESCA, IPIV,
     $                       B, IB, JB, DESCB, INFO )
      IMPLICIT NONE
*
*  -- ScaLAPACK routine --
...
*
*     INTEGER*8 native version of PCGETRS.
*     All public integer arguments are INTEGER*8 except IPIV and INFO.
*     Calls PCLAPIV_I8 and PCTRSM_I8 internally.
...
*     .. External Subroutines ..
     ...
     $                   PCHK2MAT_I8, PCLAPIV_I8, PCTRSM_I8, PXERBLA
*     ..
*     .. External Functions ..
      LOGICAL            LSAME
      INTEGER            INDXG2P_I8
...
*
      IF( INFO.NE.0 ) THEN
         CALL PXERBLA( ICTXT, 'PCGETRS_I8', -INFO )
         RETURN
      END IF
*
...
*
      IF( NOTRAN ) THEN
*
         CALL PCLAPIV_I8( 'Forward', 'Row', 'Col', N, NRHS, B, IB, JB,
     $                    DESCB, IPIV, IA, INT( 1, 8 ), DESCIP, IDUM2 )
*
         CALL PCTRSM_I8( 'Left', 'Lower', 'No transpose', 'Unit', N,
...
*
         CALL PCTRSM_I8( 'Left', 'Upper', TRANS, 'Non-unit', N,
     $                   NRHS, ONE, A, IA, JA, DESCA, B, IB, JB,
     $                   DESCB )
*
         CALL PCTRSM_I8( 'Left', 'Lower', TRANS, 'Unit', N,
     $                   NRHS, ONE, A, IA, JA, DESCA, B, IB, JB,
     $                   DESCB )
*
         CALL PCLAPIV_I8( 'Backward', 'Row', 'Col', N, NRHS, B, IB,
