      SUBROUTINE PDLASWP_I8( DIREC, ROWCOL, N, A, IA, JA, DESCA,
     $                       K1, K2, IPIV )
      IMPLICIT NONE
*
*  -- ScaLAPACK auxiliary routine --
*     INTEGER*8 thin wrapper around PDLASWP.
*
...
*     .. External Subroutines ..
      EXTERNAL           NARROW_DESC8, PDLASWP, PXERBLA
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          INT
*     ..
...
*
     ...
     $    K1.GT.INTMAX .OR. K2.GT.INTMAX ) THEN
         ...
         CALL PXERBLA( ICTXT, 'PDLASWP_I8', 1 )
         RETURN
      END IF
*
*     Narrow scalars
...
*     Call legacy routine
*
      CALL PDLASWP( DIREC, ROWCOL, N4, A, IA4, JA4, DESCA4,
     $              K14, K24, IPIV )
*
      RETURN
*
