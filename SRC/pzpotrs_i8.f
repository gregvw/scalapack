      SUBROUTINE PZPOTRS_I8( UPLO, N, NRHS, A, IA, JA, DESCA, B, IB,
     $                       JB, DESCB, INFO )
      IMPLICIT NONE
*
*  -- ScaLAPACK routine --
...
*
*     INTEGER*8 native version of PZPOTRS.
...
*  =======
*
*  PZPOTRS_I8 solves a system of linear equations
*
*                      sub( A ) * X = sub( B )
...
*
*  This is the INTEGER*8 version of PZPOTRS.
*
*  =====================================================================
*
*     .. Parameters ..
...
*
     ...
     $    IB.GT.INTMAX .OR. JB.GT.INTMAX ) THEN
         INFO = -2
         CALL PXERBLA( ICTXT, 'PZPOTRS_I8', -INFO )
         RETURN
      END IF
*
...
*
         CALL PZTRSM_I8( 'Left', 'Upper', 'Conjugate transpose',
...
*
         CALL PZTRSM_I8( 'Left', 'Lower', 'No transpose', 'Non-unit',
     $                 N, NRHS, ONE, A, IA, JA, DESCA, B, IB, JB,
     $                 DESCB )
*
*        Solve L'*X = sub( B ), overwriting sub( B ) with X.
*
         CALL PZTRSM_I8( 'Left', 'Lower', 'Conjugate transpose',
     $                 'Non-unit', N, NRHS, ONE, A, IA, JA, DESCA, B,
     $                 IB, JB, DESCB )
      END IF
*
