      SUBROUTINE PZPTTRSV_I8( UPLO, TRANS, N, NRHS, D, E, JA, DESCA,
     $                        B, IB, DESCB, AF, LAF, WORK, LWORK,
     $                        INFO )
      IMPLICIT NONE
*
*  -- ScaLAPACK auxiliary routine --
*     INTEGER*8 thin wrapper around PZPTTRSV.
*
...
*     .. External Subroutines ..
      EXTERNAL           NARROW_DESC8, PZPTTRSV
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          INT
*     ..
...
*     Call legacy routine
*
      CALL PZPTTRSV( UPLO, TRANS, N4, NRHS4, D, E, JA4, DESCA4,
     $               B, IB4, DESCB4, AF, LAF4, WORK, LWORK4,
     $               INFO )
*
      RETURN
*
