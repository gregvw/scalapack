      SUBROUTINE PDDTTRSV_I8( UPLO, TRANS, N, NRHS, DL, D, DU, JA,
     $                        DESCA, B, IB, DESCB, AF, LAF, WORK,
     $                        LWORK, INFO )
      IMPLICIT NONE
*
*  -- ScaLAPACK auxiliary routine --
*     INTEGER*8 thin wrapper around PDDTTRSV.
*
...
*     .. External Subroutines ..
      EXTERNAL           NARROW_DESC8, PDDTTRSV
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          INT
*     ..
...
*     Call legacy routine
*
      CALL PDDTTRSV( UPLO, TRANS, N4, NRHS4, DL, D, DU, JA4,
