      SUBROUTINE PSGETRS_I8( TRANS, N, NRHS, A, IA, JA, DESCA, IPIV,
     $                       B, IB, JB, DESCB, INFO )
      IMPLICIT NONE
*
*  -- ScaLAPACK routine --
...
*
*     INTEGER*8 native version of PSGETRS.
*     All public integer arguments are INTEGER*8 except IPIV and INFO.
*     Calls PSLAPIV_I8 and PSTRSM_I8 internally.
*
*     .. Scalar Arguments ..
      CHARACTER          TRANS
...
*     .. External Subroutines ..
     ...
     $                   PCHK2MAT_I8, PSLAPIV_I8, PSTRSM_I8, PXERBLA
*     ..
*     .. External Functions ..
      LOGICAL            LSAME
      INTEGER            INDXG2P_I8
...
*
      IF( INFO.NE.0 ) THEN
         CALL PXERBLA( ICTXT, 'PSGETRS_I8', -INFO )
         RETURN
      END IF
*
...
*
      IF( NOTRAN ) THEN
*
         CALL PSLAPIV_I8( 'Forward', 'Row', 'Col', N, NRHS, B, IB, JB,
     $                    DESCB, IPIV, IA, INT( 1, 8 ), DESCIP, IDUM2 )
*
         CALL PSTRSM_I8( 'Left', 'Lower', 'No transpose', 'Unit', N,
     $                   NRHS, ONE, A, IA, JA, DESCA, B, IB, JB,
     $                   DESCB )
*
         CALL PSTRSM_I8( 'Left', 'Upper', 'No transpose', 'Non-unit',
     $                   N, NRHS, ONE, A, IA, JA, DESCA, B, IB, JB,
     $                   DESCB )
      ELSE
*
         CALL PSTRSM_I8( 'Left', 'Upper', 'Transpose', 'Non-unit', N,
     $                   NRHS, ONE, A, IA, JA, DESCA, B, IB, JB,
     $                   DESCB )
*
         CALL PSTRSM_I8( 'Left', 'Lower', 'Transpose', 'Unit', N,
     $                   NRHS, ONE, A, IA, JA, DESCA, B, IB, JB,
     $                   DESCB )
*
         CALL PSLAPIV_I8( 'Backward', 'Row', 'Col', N, NRHS, B, IB,
