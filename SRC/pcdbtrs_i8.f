      SUBROUTINE PCDBTRS_I8( TRANS, N, BWL, BWU, NRHS, A, JA, DESCA,
     $                       B, IB, DESCB, AF, LAF, WORK, LWORK,
     $                       INFO )
      IMPLICIT NONE
*
*  -- ScaLAPACK routine --
*     INTEGER*8 thin wrapper around PCDBTRS.
*
...
*     Call legacy routine
*
      CALL PCDBTRS( TRANS, N4, BWL4, BWU4, NRHS4, A, JA4, DESCA4,
