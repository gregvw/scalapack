      SUBROUTINE PCUNMTR_I8( SIDE, UPLO, TRANS, M, N, A, IA, JA,
     $                       DESCA, TAU, C, IC, JC, DESCC, WORK,
     $                       LWORK, INFO )
      IMPLICIT NONE
*
*  -- ScaLAPACK auxiliary routine --
*     INTEGER*8 thin wrapper around PCUNMTR.
*
*     .. Scalar Arguments ..
...
*
      CALL PCUNMTR( SIDE, UPLO, TRANS, M4, N4, A, IA4, JA4, DESCA4,
