      SUBROUTINE PDGESVD_I8( JOBU, JOBVT, M, N, A, IA, JA, DESCA,
     $                       S, U, IU, JU, DESCU, VT, IVT, JVT,
     $                       DESCVT, WORK, LWORK, INFO )
      IMPLICIT NONE
*
*  -- ScaLAPACK routine --
*     INTEGER*8 thin wrapper around PDGESVD.
*
*     .. Scalar Arguments ..
...
*     .. External Subroutines ..
      EXTERNAL           NARROW_DESC8, PDGESVD, PXERBLA
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          INT
*     ..
...
*
     ...
     $    IVT.GT.INTMAX .OR. JVT.GT.INTMAX ) THEN
         INFO = -1
         CALL PXERBLA( ICTXT, 'PDGESVD_I8', -1 )
         RETURN
      END IF
*
      M4   = INT( M )
...
*
      CALL PDGESVD( JOBU, JOBVT, M4, N4, A, IA4, JA4, DESCA4,
     $              S, U, IU4, JU4, DESCU4, VT, IVT4, JVT4,
     $              DESCVT4, WORK, LWORK4, INFO )
*
      RETURN
*
*     End of PDGESVD_I8
