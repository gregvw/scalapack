      SUBROUTINE PSDBTRF_I8( N, BWL, BWU, A, JA, DESCA, AF, LAF,
     $                       WORK, LWORK, INFO )
      IMPLICIT NONE
*
*  -- ScaLAPACK routine --
*     INTEGER*8 thin wrapper around PSDBTRF.
*
...
*     Call legacy routine
*
      CALL PSDBTRF( N4, BWL4, BWU4, A, JA4, DESCA4, AF, LAF4,
     $              WORK, LWORK4, INFO )
*
      RETURN
*
