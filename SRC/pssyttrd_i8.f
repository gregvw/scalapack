      SUBROUTINE PSSYTTRD_I8( UPLO, N, A, IA, JA, DESCA, D, E, TAU,
     $                       WORK, LWORK, INFO )
      IMPLICIT NONE
*
*  -- ScaLAPACK auxiliary routine --
*     INTEGER*8 thin wrapper around PSSYTTRD.
*
*     .. Scalar Arguments ..
      CHARACTER          UPLO
...
*     .. External Subroutines ..
      EXTERNAL           NARROW_DESC8, PSSYTTRD
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          INT, MIN
*     ..
...
*
      CALL PSSYTTRD( UPLO, N4, A, IA4, JA4, DESCA4, D, E, TAU,
     $               WORK, LWORK4, INFO )
*
      RETURN
      END
