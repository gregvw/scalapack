      SUBROUTINE PDDTTRF_I8( N, DL, D, DU, JA, DESCA, AF, LAF,
     $                       WORK, LWORK, INFO )
      IMPLICIT NONE
*
*  -- ScaLAPACK auxiliary routine --
*     INTEGER*8 thin wrapper around PDDTTRF.
*
...
*     Call legacy routine
*
      CALL PDDTTRF( N4, DL, D, DU, JA4, DESCA4, AF, LAF4, WORK,
     $              LWORK4, INFO )
*
      RETURN
*
