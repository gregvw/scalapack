      SUBROUTINE PCHETTRD_I8( UPLO, N, A, IA, JA, DESCA, D, E, TAU,
     $                       WORK, LWORK, INFO )
      IMPLICIT NONE
*
*  -- ScaLAPACK auxiliary routine --
*     INTEGER*8 thin wrapper around PCHETTRD.
*
*     .. Scalar Arguments ..
      CHARACTER          UPLO
...
*     .. External Subroutines ..
      EXTERNAL           NARROW_DESC8, PCHETTRD
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          INT, MIN
*     ..
...
*
      CALL PCHETTRD( UPLO, N4, A, IA4, JA4, DESCA4, D, E, TAU,
     $               WORK, LWORK4, INFO )
*
      RETURN
      END
