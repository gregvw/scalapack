      SUBROUTINE PDPOTRS_I8( UPLO, N, NRHS, A, IA, JA, DESCA, B, IB,
     $                       JB, DESCB, INFO )
      IMPLICIT NONE
*
*  -- ScaLAPACK routine --
...
*
*     INTEGER*8 native version of PDPOTRS.
...
*  =======
*
*  PDPOTRS_I8 solves a system of linear equations
*
*                      sub( A ) * X = sub( B )
...
*
*  This is the INTEGER*8 version of PDPOTRS.
*
*  =====================================================================
*
*     .. Parameters ..
...
*
         CALL PDTRSM_I8( 'Left', 'Lower', 'No transpose', 'Non-unit',
     $                 N, NRHS, ONE, A, IA, JA, DESCA, B, IB, JB,
     $                 DESCB )
*
*        Solve L'*X = sub( B ), overwriting sub( B ) with X.
*
         CALL PDTRSM_I8( 'Left', 'Lower', 'Transpose', 'Non-unit', N,
