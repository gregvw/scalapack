      SUBROUTINE PDGEBRD_I8( M, N, A, IA, JA, DESCA, D, E, TAUQ,
     $                       TAUP, WORK, LWORK, INFO )
      IMPLICIT NONE
*
*  -- ScaLAPACK routine --
*     INTEGER*8 thin wrapper around PDGEBRD.
*
*  PDGEBRD_I8 reduces a real general M-by-N distributed matrix
...
*     .. External Subroutines ..
      EXTERNAL           NARROW_DESC8, PDGEBRD, PXERBLA
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          INT
*     ..
...
*
     ...
     $    IA.GT.INTMAX .OR. JA.GT.INTMAX ) THEN
         INFO = -1
         CALL PXERBLA( ICTXT, 'PDGEBRD_I8', -1 )
         RETURN
      END IF
*
      M4  = INT( M )
...
*
      CALL PDGEBRD( M4, N4, A, IA4, JA4, DESCA4, D, E, TAUQ,
