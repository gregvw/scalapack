...
*     .. External Subroutines ..
     ...
     $                   CHK1MAT_I8, DESCSET_I8, SSYTRD_I8,
     $                   DGAMN2D, PCHK1MAT_I8, PSELSET_I8,
     $                   PSLAMR1D_I8, PSLATRD_I8, PSSYR2K_I8,
     $                   PSSYTD2_I8, PSSYTTRD_I8, PSTRMR2D_I8,
...
*
            IF( NPROWB.EQ.1 ) THEN
               CALL SSYTRD_I8( UPLO, N, WORK( INDB ), NPS8,
     $                         WORK( INDD ), WORK( INDE ),
     $                         WORK( INDTAU ), WORK( INDW ),
     $                         LLWORK, IINFO )
            ELSE
               CALL PSSYTTRD_I8( 'L', N, WORK( INDB ), 1_8, 1_8,
...
*
     ...
     $              DESCW, WORK( IPW ) )
*
               CALL PSSYR2K_I8( UPLO, 'No transpose', K8-1,
...
*
   10       CONTINUE
*
            CALL PSSYTD2_I8( UPLO, MIN( N, INT( NB, 8 ) ), A, IA,
...
*
     ...
     $              WORK( IPW ) )
*
               CALL PSSYR2K_I8( UPLO, 'No transpose', N-K8-NB+1,
...
*
   20       CONTINUE
*
            CALL PSSYTD2_I8( UPLO, INT( KK, 8 ), A, IA+K8-1,
