      SUBROUTINE PSDBTRSV_I8( UPLO, TRANS, N, BWL, BWU, NRHS, A, JA,
     $                        DESCA, B, IB, DESCB, AF, LAF, WORK,
     $                        LWORK, INFO )
      IMPLICIT NONE
*
*  -- ScaLAPACK routine --
*     INTEGER*8 thin wrapper around PSDBTRSV.
*
...
*     .. External Subroutines ..
      EXTERNAL           NARROW_DESC8, PSDBTRSV
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          INT
*     ..
...
*     Call legacy routine
*
      CALL PSDBTRSV( UPLO, TRANS, N4, BWL4, BWU4, NRHS4, A, JA4,
