      SUBROUTINE PZPBTRF_I8( UPLO, N, BW, A, JA, DESCA, AF, LAF,
     $                       WORK, LWORK, INFO )
      IMPLICIT NONE
*
*  -- ScaLAPACK auxiliary routine --
*     INTEGER*8 thin wrapper around PZPBTRF.
*
...
*     Call legacy routine
*
      CALL PZPBTRF( UPLO, N4, BW4, A, JA4, DESCA4, AF, LAF4,
     $              WORK, LWORK4, INFO )
*
      RETURN
*
