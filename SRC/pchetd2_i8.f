      SUBROUTINE PCHETD2_I8( UPLO, N, A, IA, JA, DESCA, D, E, TAU,
     $                       WORK, LWORK, INFO )
      IMPLICIT NONE
*
*  -- ScaLAPACK auxiliary routine --
*     INTEGER*8 thin wrapper around PCHETD2.
*
...
*     Call legacy routine
*
      CALL PCHETD2( UPLO, N4, A, IA4, JA4, DESCA4, D, E, TAU,
     $              WORK, LWORK4, INFO )
*
      RETURN
*
