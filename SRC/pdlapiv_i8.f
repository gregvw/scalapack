      SUBROUTINE PDLAPIV_I8( DIREC, ROWCOL, PIVROC, M, N, A, IA, JA,
     $                       DESCA, IPIV, IP, JP, DESCIP, IWORK )
      IMPLICIT NONE
*
*  -- ScaLAPACK auxiliary routine --
*     INTEGER*8 thin wrapper around PDLAPIV.
*
...
*     .. External Subroutines ..
      EXTERNAL           NARROW_DESC8, PDLAPIV, PXERBLA
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          INT
*     ..
...
*
     ...
     $    IP.GT.INTMAX .OR. JP.GT.INTMAX ) THEN
         ...
         CALL PXERBLA( ICTXT, 'PDLAPIV_I8', 1 )
         RETURN
      END IF
*
*     Narrow scalars
...
*     Call legacy routine
*
      CALL PDLAPIV( DIREC, ROWCOL, PIVROC, M4, N4, A, IA4, JA4,
