...
*     INFO stays INTEGER.
*     Uses I8 calls for PCHERK, PCTRSM, and PCPOTF2.
*
*     .. Scalar Arguments ..
      CHARACTER          UPLO
      INTEGER*8          N, IA, JA
...
*     .. External Subroutines ..
     ...
     $                   PB_TOPGET, PB_TOPSET, PCPOTF2_I8,
...
*
         CALL PCPOTF2_I8( UPLO, INT( JB, 8 ), A, IA, JA, DESCA,
     $                 INFO )
         IF( INFO.NE.0 )
     $      GO TO 30
*
...
*           Perform unblocked Cholesky factorization on JB block
*
            CALL PCPOTF2_I8( UPLO, INT( JB, 8 ), A, I, J, DESCA,
     $                    INFO )
            IF( INFO.NE.0 ) THEN
               INFO = INFO + INT( J - JA )
               GO TO 30
