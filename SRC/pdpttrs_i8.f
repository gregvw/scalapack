      SUBROUTINE PDPTTRS_I8( N, NRHS, D, E, JA, DESCA, B, IB, DESCB,
     $                       AF, LAF, WORK, LWORK, INFO )
      IMPLICIT NONE
*
*  -- ScaLAPACK auxiliary routine --
*     INTEGER*8 thin wrapper around PDPTTRS.
*
...
*     Call legacy routine
*
      CALL PDPTTRS( N4, NRHS4, D, E, JA4, DESCA4, B, IB4, DESCB4,
