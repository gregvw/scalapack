      SUBROUTINE PZDTTRS_I8( TRANS, N, NRHS, DL, D, DU, JA, DESCA,
     $                       B, IB, DESCB, AF, LAF, WORK, LWORK,
     $                       INFO )
      IMPLICIT NONE
*
*  -- ScaLAPACK auxiliary routine --
*     INTEGER*8 thin wrapper around PZDTTRS.
*
...
*     Call legacy routine
*
      CALL PZDTTRS( TRANS, N4, NRHS4, DL, D, DU, JA4, DESCA4, B,
     $              IB4, DESCB4, AF, LAF4, WORK, LWORK4, INFO )
*
      RETURN
*
*     End of PZDTTRS_I8
