      SUBROUTINE PCLASET_I8( UPLO, M, N, ALPHA, BETA, A, IA, JA,
     $                       DESCA )
      IMPLICIT NONE
*
*  -- ScaLAPACK auxiliary routine --
*     INTEGER*8 thin wrapper around PCLASET.
*
*     .. Scalar Arguments ..
      CHARACTER          UPLO
      INTEGER*8          M, N, IA, JA
...
*  =======
*
*  PCLASET_I8 is an INTEGER*8 wrapper around PCLASET.  It accepts
...
*     .. External Subroutines ..
      EXTERNAL           NARROW_DESC8, PCLASET, PXERBLA
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          INT
*     ..
...
*
     ...
     $    IA.GT.INTMAX .OR. JA.GT.INTMAX ) THEN
         CALL PXERBLA( ICTXT, 'PCLASET_I8', -1 )
         RETURN
      END IF
*
      M4  = INT( M )
...
*
      CALL PCLASET( UPLO, M4, N4, ALPHA, BETA, A, IA4, JA4, DESCA4 )
*
      RETURN
*
*     End of PCLASET_I8
