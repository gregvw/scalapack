      SUBROUTINE PCGETRI_I8( N, A, IA, JA, DESCA, IPIV, WORK, LWORK,
     $                       IWORK, LIWORK, INFO )
      IMPLICIT NONE
*
*  -- ScaLAPACK routine --
*     INTEGER*8 thin wrapper around PCGETRI.
*
*     .. Scalar Arguments ..
...
*     .. External Subroutines ..
      EXTERNAL           NARROW_DESC8, PCGETRI, PXERBLA
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          INT
*     ..
...
*
     ...
     $    IA.GT.INTMAX .OR. JA.GT.INTMAX ) THEN
         INFO = -1
         CALL PXERBLA( ICTXT, 'PCGETRI_I8', -1 )
         RETURN
      END IF
*
      N4  = INT( N )
...
*
      CALL PCGETRI( N4, A, IA4, JA4, DESCA4, IPIV, WORK, LWORK4,
     $              IWORK, LIWORK4, INFO )
*
      RETURN
*
