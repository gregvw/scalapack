      SUBROUTINE PSGBTRS_I8( TRANS, N, BWL, BWU, NRHS, A, JA, DESCA,
     $                       IPIV, B, IB, DESCB, AF, LAF, WORK,
     $                       LWORK, INFO )
      IMPLICIT NONE
*
*  -- ScaLAPACK routine --
*     INTEGER*8 thin wrapper around PSGBTRS.
*
...
*     Call legacy routine
*
      CALL PSGBTRS( TRANS, N4, BWL4, BWU4, NRHS4, A, JA4, DESCA4,
