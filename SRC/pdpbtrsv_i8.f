      SUBROUTINE PDPBTRSV_I8( UPLO, TRANS, N, BW, NRHS, A, JA,
     $                        DESCA, B, IB, DESCB, AF, LAF,
     $                        WORK, LWORK, INFO )
      IMPLICIT NONE
*
*  -- ScaLAPACK auxiliary routine --
*     INTEGER*8 thin wrapper around PDPBTRSV.
*
...
*     .. External Subroutines ..
      EXTERNAL           NARROW_DESC8, PDPBTRSV
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          INT
*     ..
...
*     Call legacy routine
*
      CALL PDPBTRSV( UPLO, TRANS, N4, BW4, NRHS4, A, JA4, DESCA4,
