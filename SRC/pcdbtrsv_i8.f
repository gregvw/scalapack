      SUBROUTINE PCDBTRSV_I8( UPLO, TRANS, N, BWL, BWU, NRHS, A, JA,
     $                        DESCA, B, IB, DESCB, AF, LAF, WORK,
     $                        LWORK, INFO )
      IMPLICIT NONE
*
*  -- ScaLAPACK routine --
*     INTEGER*8 thin wrapper around PCDBTRSV.
*
...
*     .. External Subroutines ..
      EXTERNAL           NARROW_DESC8, PCDBTRSV
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          INT
*     ..
...
*     Call legacy routine
*
      CALL PCDBTRSV( UPLO, TRANS, N4, BWL4, BWU4, NRHS4, A, JA4,
