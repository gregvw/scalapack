      SUBROUTINE PSORGQR_I8( M, N, K, A, IA, JA, DESCA, TAU, WORK,
     $                       LWORK, INFO )
      IMPLICIT NONE
*
*  -- ScaLAPACK routine --
*     INTEGER*8 thin wrapper around PSORGQR.
*
*     .. Scalar Arguments ..
...
*     .. External Subroutines ..
      EXTERNAL           NARROW_DESC8, PSORGQR, PXERBLA
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          INT
*     ..
...
*
     ...
     $    IA.GT.INTMAX .OR. JA.GT.INTMAX ) THEN
         INFO = -1
         CALL PXERBLA( ICTXT, 'PSORGQR_I8', -1 )
         RETURN
      END IF
*
      M4  = INT( M )
...
*
      CALL PSORGQR( M4, N4, K4, A, IA4, JA4, DESCA4, TAU, WORK,
     $              LWORK4, INFO )
*
      RETURN
*
