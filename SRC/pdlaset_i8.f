      SUBROUTINE PDLASET_I8( UPLO, M, N, ALPHA, BETA, A, IA, JA,
     $                       DESCA )
      IMPLICIT NONE
*
*  -- ScaLAPACK auxiliary routine --
*     INTEGER*8 thin wrapper around PDLASET.
*
*     .. Scalar Arguments ..
      CHARACTER          UPLO
      INTEGER*8          M, N, IA, JA
...
*  =======
*
*  PDLASET_I8 is an INTEGER*8 wrapper around PDLASET.  It accepts
...
*     .. External Subroutines ..
      EXTERNAL           NARROW_DESC8, PDLASET, PXERBLA
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          INT
*     ..
...
*
     ...
     $    IA.GT.INTMAX .OR. JA.GT.INTMAX ) THEN
         CALL PXERBLA( ICTXT, 'PDLASET_I8', -1 )
         RETURN
      END IF
*
      M4  = INT( M )
...
*
      CALL PDLASET( UPLO, M4, N4, ALPHA, BETA, A, IA4, JA4, DESCA4 )
*
      RETURN
*
*     End of PDLASET_I8
