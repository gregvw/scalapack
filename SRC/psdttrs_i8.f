      SUBROUTINE PSDTTRS_I8( TRANS, N, NRHS, DL, D, DU, JA, DESCA,
     $                       B, IB, DESCB, AF, LAF, WORK, LWORK,
     $                       INFO )
      IMPLICIT NONE
*
*  -- ScaLAPACK auxiliary routine --
*     INTEGER*8 thin wrapper around PSDTTRS.
*
...
*     Call legacy routine
*
      CALL PSDTTRS( TRANS, N4, NRHS4, DL, D, DU, JA4, DESCA4, B,
