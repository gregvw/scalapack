      REAL               FUNCTION PCLANGE_I8( NORM, M, N, A, IA, JA,
     $                                          DESCA, WORK )
      IMPLICIT NONE
*
*  -- ScaLAPACK auxiliary routine --
*     INTEGER*8 thin wrapper around PCLANGE.
*
*     .. Scalar Arguments ..
      CHARACTER          NORM
      INTEGER*8          M, N, IA, JA
...
*
     ...
     $    IA.GT.INTMAX .OR. JA.GT.INTMAX ) THEN
         CALL PXERBLA( ICTXT, 'PCLANGE_I8', -1 )
         PCLANGE_I8 = -1.0
         RETURN
      END IF
*
...
*
      PCLANGE_I8 = PCLANGE( NORM, M4, N4, A, IA4, JA4, DESCA4,
     $                       WORK )
*
      RETURN
*
