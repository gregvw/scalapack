      SUBROUTINE PSGESV_I8( N, NRHS, A, IA, JA, DESCA, IPIV, B, IB,
     $                      JB, DESCB, INFO )
      IMPLICIT NONE
*
*  -- ScaLAPACK routine --
...
*
*     INTEGER*8 native version of PSGESV.
*     All public integer arguments are INTEGER*8 except IPIV and INFO.
*     Calls PSGETRF_I8 and PSGETRS_I8 internally.
*
*     .. Scalar Arguments ..
...
*
      IF( INFO.NE.0 ) THEN
         CALL PXERBLA( ICTXT, 'PSGESV_I8', -INFO )
         RETURN
      END IF
*
*     Compute the LU factorization of sub( A ).
*
      CALL PSGETRF_I8( N, N, A, IA, JA, DESCA, IPIV, INFO )
*
      IF( INFO.EQ.0 ) THEN
*
         CALL PSGETRS_I8( 'No transpose', N, NRHS, A, IA, JA, DESCA,
