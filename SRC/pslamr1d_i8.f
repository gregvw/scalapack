      SUBROUTINE PSLAMR1D_I8( N, A, IA, JA, DESCA,
     $                        B, IB, JB, DESCB )
      IMPLICIT NONE
*
*  -- ScaLAPACK routine --
...
*
*     INTEGER*8 version of PSLAMR1D.  See PDLAMR1D_I8 for full docs.
*
*     .. Scalar Arguments ..
...
*
      ...
      CALL PSGEMR2D_I8( 1_8, N, A, IA, JA, DESCAA,
...
*
      IF( NQ8 .GT. 2147483647_8 ) THEN
         CALL PXERBLA( ICTXT, 'PSLAMR1D_I8', -1 )
         CALL BLACS_ABORT( ICTXT, 1 )
      END IF
      NQ4 = INT( NQ8 )
*
      IF( MYROW.EQ.0 ) THEN
         CALL SGEBS2D( ICTXT, 'C', ' ', NQ4, 1, B, NQ4 )
      ELSE
         CALL SGEBR2D( ICTXT, 'C', ' ', NQ4, 1, B, NQ4, 0, MYCOL )
      END IF
*
      RETURN
*
