      SUBROUTINE PDGBTRS_I8( TRANS, N, BWL, BWU, NRHS, A, JA, DESCA,
     $                       IPIV, B, IB, DESCB, AF, LAF, WORK,
     $                       LWORK, INFO )
      IMPLICIT NONE
*
*  -- ScaLAPACK routine --
*     INTEGER*8 thin wrapper around PDGBTRS.
*
...
*     Call legacy routine
*
      CALL PDGBTRS( TRANS, N4, BWL4, BWU4, NRHS4, A, JA4, DESCA4,
     $              IPIV, B, IB4, DESCB4, AF, LAF4, WORK, LWORK4,
     $              INFO )
*
      RETURN
*
