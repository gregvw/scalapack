      SUBROUTINE PDPTTRSV_I8( UPLO, N, NRHS, D, E, JA, DESCA, B, IB,
     $                        DESCB, AF, LAF, WORK, LWORK, INFO )
      IMPLICIT NONE
*
*  -- ScaLAPACK auxiliary routine --
*     INTEGER*8 thin wrapper around PDPTTRSV.
*
...
*     .. External Subroutines ..
      EXTERNAL           NARROW_DESC8, PDPTTRSV
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          INT
*     ..
...
*     Call legacy routine
*
      CALL PDPTTRSV( UPLO, N4, NRHS4, D, E, JA4, DESCA4, B, IB4,
