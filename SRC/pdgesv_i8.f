      SUBROUTINE PDGESV_I8( N, NRHS, A, IA, JA, DESCA, IPIV, B, IB,
     $                      JB, DESCB, INFO )
      IMPLICIT NONE
*
*  -- ScaLAPACK routine --
...
*
*     INTEGER*8 native version of PDGESV.
*     All public integer arguments are INTEGER*8 except IPIV and INFO.
*     Calls PDGETRF_I8 and PDGETRS_I8 internally.
*
*     .. Scalar Arguments ..
...
*
      IF( INFO.NE.0 ) THEN
         CALL PXERBLA( ICTXT, 'PDGESV_I8', -INFO )
         RETURN
      END IF
*
*     Compute the LU factorization of sub( A ).
*
      CALL PDGETRF_I8( N, N, A, IA, JA, DESCA, IPIV, INFO )
*
      IF( INFO.EQ.0 ) THEN
*
...
*        with X.
*
         CALL PDGETRS_I8( 'No transpose', N, NRHS, A, IA, JA, DESCA,
