      SUBROUTINE PZLASET_I8( UPLO, M, N, ALPHA, BETA, A, IA, JA,
     $                       DESCA )
      IMPLICIT NONE
*
*  -- ScaLAPACK auxiliary routine --
*     INTEGER*8 thin wrapper around PZLASET.
*
*     .. Scalar Arguments ..
      CHARACTER          UPLO
      INTEGER*8          M, N, IA, JA
...
*  =======
*
*  PZLASET_I8 is an INTEGER*8 wrapper around PZLASET.  It accepts
...
*     .. External Subroutines ..
      EXTERNAL           NARROW_DESC8, PZLASET, PXERBLA
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          INT
*     ..
...
*
     ...
     $    IA.GT.INTMAX .OR. JA.GT.INTMAX ) THEN
         CALL PXERBLA( ICTXT, 'PZLASET_I8', -1 )
         RETURN
      END IF
*
      M4  = INT( M )
...
*
      CALL PZLASET( UPLO, M4, N4, ALPHA, BETA, A, IA4, JA4, DESCA4 )
*
      RETURN
*
*     End of PZLASET_I8
