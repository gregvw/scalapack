      SUBROUTINE PZGETF2_I8( M, N, A, IA, JA, DESCA, IPIV, INFO )
      IMPLICIT NONE
*
*  -- ScaLAPACK routine --
...
*
*     INTEGER*8 native version of PZGETF2.
...
*  =======
*
*  PZGETF2_I8 computes an LU factorization of a general M-by-N
...
*     .. External Subroutines ..
     ...
     $                   PZAMAX_I8, PZGERU_I8,
     $                   PZSCAL_I8, PZSWAP_I8, PB_TOPGET, PXERBLA
*     ..
*     .. Intrinsic Functions ..
...
*
      IF( INFO.NE.0 ) THEN
         CALL PXERBLA( ICTXT, 'PZGETF2_I8', -INFO )
...
*
            CALL PZAMAX_I8( M-J+JA, GMAX, IPIV( INT(IIA+J-JA) ),
     $                      A, I, J, DESCA, 1_8 )
...
*
               ...
               CALL PZSWAP_I8( N, A, I, JA, DESCA, DESCA( M_ ), A,
     $                         IPIV8, JA, DESCA, DESCA( M_ ) )
*
*              Compute elements I+1:IA+M-1 of J-th column.
*
               IF( J-JA+1.LT.M )
     $            CALL PZSCAL_I8( M-J+JA-1, ONE / GMAX, A, I+1, J,
     $                            DESCA, 1_8 )
...
*
            IF( J-JA+1.LT.MN ) THEN
               CALL PZGERU_I8( M-J+JA-1, N-J+JA-1, -ONE, A, I+1, J,
