      SUBROUTINE PDPBTRS_I8( UPLO, N, BW, NRHS, A, JA, DESCA, B, IB,
     $                       DESCB, AF, LAF, WORK, LWORK, INFO )
      IMPLICIT NONE
*
*  -- ScaLAPACK auxiliary routine --
*     INTEGER*8 thin wrapper around PDPBTRS.
*
...
*     Call legacy routine
*
      CALL PDPBTRS( UPLO, N4, BW4, NRHS4, A, JA4, DESCA4, B, IB4,
