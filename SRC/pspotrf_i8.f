...
*     INFO stays INTEGER.
*     Uses I8 calls for PSSYRK, PSTRSM, and PSPOTF2.
*
*     .. Scalar Arguments ..
      CHARACTER          UPLO
      INTEGER*8          N, IA, JA
...
*     .. External Subroutines ..
     ...
     $                   PB_TOPGET, PB_TOPSET, PSPOTF2_I8,
...
*
         CALL PSPOTF2_I8( UPLO, INT( JB, 8 ), A, IA, JA, DESCA,
     $                 INFO )
         IF( INFO.NE.0 )
     $      GO TO 30
*
...
*           Perform unblocked Cholesky factorization on JB block
*
            CALL PSPOTF2_I8( UPLO, INT( JB, 8 ), A, I, J, DESCA,
     $                    INFO )
            IF( INFO.NE.0 ) THEN
               INFO = INFO + INT( J - JA )
               GO TO 30
