      SUBROUTINE PZGESV_I8( N, NRHS, A, IA, JA, DESCA, IPIV, B, IB,
     $                      JB, DESCB, INFO )
      IMPLICIT NONE
*
*  -- ScaLAPACK routine --
...
*
*     INTEGER*8 native version of PZGESV.
*     All public integer arguments are INTEGER*8 except IPIV and INFO.
*     Calls PZGETRF_I8 and PZGETRS_I8 internally.
*
*     .. Scalar Arguments ..
...
*
      IF( INFO.NE.0 ) THEN
         CALL PXERBLA( ICTXT, 'PZGESV_I8', -INFO )
         RETURN
      END IF
*
*     Compute the LU factorization of sub( A ).
*
      CALL PZGETRF_I8( N, N, A, IA, JA, DESCA, IPIV, INFO )
*
      IF( INFO.EQ.0 ) THEN
*
         CALL PZGETRS_I8( 'No transpose', N, NRHS, A, IA, JA, DESCA,
