      SUBROUTINE PCPTTRF_I8( N, D, E, JA, DESCA, AF, LAF, WORK,
     $                       LWORK, INFO )
      IMPLICIT NONE
*
*  -- ScaLAPACK auxiliary routine --
*     INTEGER*8 thin wrapper around PCPTTRF.
*
...
*     Call legacy routine
*
      CALL PCPTTRF( N4, D, E, JA4, DESCA4, AF, LAF4, WORK,
     $              LWORK4, INFO )
*
      RETURN
*
