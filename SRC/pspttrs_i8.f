      SUBROUTINE PSPTTRS_I8( N, NRHS, D, E, JA, DESCA, B, IB, DESCB,
     $                       AF, LAF, WORK, LWORK, INFO )
      IMPLICIT NONE
*
*  -- ScaLAPACK auxiliary routine --
*     INTEGER*8 thin wrapper around PSPTTRS.
*
...
*     Call legacy routine
*
      CALL PSPTTRS( N4, NRHS4, D, E, JA4, DESCA4, B, IB4, DESCB4,
     $              AF, LAF4, WORK, LWORK4, INFO )
*
      RETURN
*
*     End of PSPTTRS_I8
