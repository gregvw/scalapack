      SUBROUTINE PZGBTRF_I8( N, BWL, BWU, A, JA, DESCA, IPIV, AF,
     $                       LAF, WORK, LWORK, INFO )
      IMPLICIT NONE
*
*  -- ScaLAPACK routine --
*     INTEGER*8 thin wrapper around PZGBTRF.
*
...
*     Call legacy routine
*
      CALL PZGBTRF( N4, BWL4, BWU4, A, JA4, DESCA4, IPIV, AF,
