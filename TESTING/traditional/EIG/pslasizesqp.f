      SUBROUTINE PSLASIZESQP( DESCA, IPREPAD, IPOSTPAD, SIZEMQRLEFT,
...
*     .. Scalar Arguments ..
     ...
     $                   SIZEQRF, SIZEQTQ, SIZESUBTST, SIZESYEV,
     $                   SIZESYEVX, SIZETMS, SIZETST,
...
*  =======
*
*  PSLASIZESQP computes the amount of memory needed by
*  various SEP test routines, as well as PSYEVX and PSSYEV
*
*  Arguments
*  =========
*
*  DESCA        (global input) INTEGER array dimension ( DLEN_ )
*               Array descriptor as passed to PSSYEVX or PSSYEV
*
...
*
*  SIZEQTQ      LWORK for PSSEPQTQ (nexer complex)
*
*  SIZECHK      LWORK for PSSEPCHK
*
*  SIZESYEVX    LWORK for PSSYEVX
*
*  ISIZESYEVX   LIWORK for PSSYEVX
*
*  SIZESYEV     LWORK for PSSYEV
*
*  SIZESYEVD    LWORK for PSSYEVD
*
*  ISIZESYEVD   LIWORK for PSSYEVD
*
*  SIZESUBTST   LWORK for PSSUBTST
*
*  ISIZESUBTST  LIWORK for PSSUBTST
*
*  SIZETST      LWORK for PSTST
*
...
*
     ...
     $            ICEIL( NEIG, NPROW*NPCOL )*NN
      ...
      ISIZESYEVX = 6*NNP
*
*     Allow room for the new context created in PSSYEV
*
...
*
*     Allow room for IFAIL, ICLUSTR, and IWORK (all in PSSYEVX)
*
