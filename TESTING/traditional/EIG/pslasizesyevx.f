*
*
      SUBROUTINE PSLASIZESYEVX( WKNOWN, RANGE, N, DESCA, VL, VU, IL, IU,
...
*  =======
*
*  PSLASIZESYEVX computes the amount of memory needed by PSSYEVX
*  to ensure:
...
*          Workspace required to guarantee that PSSYEVX will return
...
*          Workspace required to guarantee that PSSYEVX
