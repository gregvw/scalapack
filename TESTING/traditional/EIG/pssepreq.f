*
*
      SUBROUTINE PSSEPREQ( HETERO, NIN, MEM, MEMSIZE, NOUT, ISEED,
...
*  =======
*
*  PSSEPREQ performs one request from the input file 'SEP.dat'
*  A request is the cross product of the specifications in the
*  input file.  PSSEPREQ prints one line per test.
*
*  Arguments
*  =========
*
...
*     .. Local Scalars ..
     ...
     $                   SIZETMS, SIZETST, UPLO, SIZESYEVD, ISIZESYEVD
      REAL               ABSTOL, THRESH
*     ..
*     .. Local Arrays ..
      CHARACTER          UPLOS( 2 )
...
*     .. External Subroutines ..
     ...
     $                   DESCINIT, PSLASIZESQP, PSSEPINFO, PSSEPTST
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX
*     ..
...
*
     ...
     $                                 CONTEXT, LDA, INFO )
                        CALL PSLASIZESQP( DESCA, IPREPAD, IPOSTPAD,
...
C    $                           IPOSTPAD + 1
                        ...
                        IF( LLWORK.LT.SIZETST ) THEN
                           NSKIPPED = NSKIPPED + 1
                        ELSE
                           CALL PSSEPTST( DESCA, UPLOS( UPLO ), N,
...
*
                           ...
                           ELSE IF( RES.EQ.3 ) THEN
                              NSKIPPED = NSKIPPED + 1
                              WRITE( NOUT, FMT = * )' PSSEPREQ failed'
