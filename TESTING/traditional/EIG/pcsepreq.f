...
*  =======
*
*  PCSEPREQ performs one request from the input file 'SEP.dat'
*  A request is the cross product of the specifications in the
*  input file.  PCSEPREQ prints one line per test.
*
*  Arguments
*  =========
*
...
*     .. Local Scalars ..
     ...
     $                   SIZETST, UPLO,SIZEHEEVD, RSIZEHEEVD, ISIZEHEEVD
      REAL               ABSTOL, THRESH
*     ..
*     .. Local Arrays ..
      CHARACTER          UPLOS( 2 )
...
*     .. External Subroutines ..
     ...
     $                   DESCINIT, PCLASIZESEP, PCSEPTST, PSSEPINFO
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX
*     ..
...
*
     ...
     $                             IPOSTPAD, CPLXSZ / INTGSZ )
                        LLRWORK = ( MEMSIZE-PTRRWORK+1 )*CPLXSZ / REALSZ
...
C    $                            *CPLXSZ / REALSZ
                        ...
                        IF( LLRWORK.LT.RSIZETST ) THEN
                           NSKIPPED = NSKIPPED + 1
                        ELSE
                           CALL PCSEPTST( DESCA, UPLOS( UPLO ), N,
...
*
                           ...
                           ELSE IF( RES.EQ.3 ) THEN
                              NSKIPPED = NSKIPPED + 1
                              WRITE( NOUT, FMT=*)'pCSEPREQ failed'
