/*
 * pcamax_i8.c -- I8 entry point for PCAMAX.
 */
#include "pblas_i8_utils.h"
#include "PBblas.h"

extern void pcamax_(Int *, float *, Int *,
                    float *, Int *, Int *, Int *, Int *);

void pcamax_i8_(int64_t *N, float *AMAX, Int *INDX,
                ...
                int64_t *INCX)
{
    ...
    {
        pblas_i8_abort((Int)DESCX[1], "PCAMAX_I8");
        return;
    }

    pcamax_(&n4, AMAX, INDX,
