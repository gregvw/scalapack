/*
 * pzgeru_i8.c -- I8 entry point for PZGERU.
 */
#include "pblas_i8_utils.h"
#include "PBblas.h"

extern void pzgeru_(Int *, Int *, double *,
                    double *, Int *, Int *, Int *, Int *,
                    double *, Int *, Int *, Int *, Int *,
                    double *, Int *, Int *, Int *);

void pzgeru_i8_(int64_t *M, int64_t *N, double *ALPHA,
                ...
                double *A, int64_t *IA, int64_t *JA, int64_t *DESCA)
{
    ...
    {
        pblas_i8_abort((Int)DESCA[1], "PZGERU_I8");
        return;
    }
