/*
 * psscal_i8.c — I8 entry point for PSSCAL.
 */

#include "pblas_i8_utils.h"

extern void psscal_(Int *, float *,
                    float *, Int *, Int *, Int *, Int *);

void psscal_i8_(int64_t *N, float *ALPHA,
                ...
                int64_t *INCX)
{
    ...
    {
        pblas_i8_abort((Int)DESCX[1], "PSSCAL_I8");
        return;
    }

    psscal_(&n4, ALPHA, X, &ix4, &jx4, descx4, &incx4);
}
