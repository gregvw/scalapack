/*
 * pscopy_i8.c — I8 entry point for PSCOPY.
 *
 * Takes int64_t arguments from Fortran INTEGER*8 callers, narrows
 * to Int with overflow checks, and delegates to the legacy pscopy_.
 */

#include "pblas_i8_utils.h"

/* Legacy entry point */
extern void pscopy_(Int *,
                    float *, Int *, Int *, Int *, Int *,
                    float *, Int *, Int *, Int *, Int *);

void pscopy_i8_(int64_t *N,
                ...
                int64_t *INCY)
{
    ...
    {
        pblas_i8_abort((Int)DESCX[1], "PSCOPY_I8");
        return;
    }
