/*
 * pssymv_i8.c -- I8 entry point for PSSYMV.
 */

#include "pblas_i8_utils.h"
#include "PBblas.h"

extern void pssymv_(F_CHAR_T, Int *, float *,
                    float *, Int *, Int *, Int *,
                    float *, Int *, Int *, Int *, Int *,
                    float *,
                    float *, Int *, Int *, Int *, Int *);

void pssymv_i8_(F_CHAR_T UPLO, int64_t *N, float *ALPHA,
                ...
                int64_t *INCY)
{
    ...
    {
        pblas_i8_abort((Int)DESCA[1], "PSSYMV_I8");
        return;
    }

    pssymv_(UPLO, &n4, ALPHA,
            A, &ia4, &ja4, desca4,
