/*
 * pdscal_i8.c — I8 entry point for PDSCAL.
 */

#include "pblas_i8_utils.h"

extern void pdscal_(Int *, double *,
                    double *, Int *, Int *, Int *, Int *);

void pdscal_i8_(int64_t *N, double *ALPHA,
                ...
                int64_t *INCX)
{
    ...
    {
        pblas_i8_abort((Int)DESCX[1], "PDSCAL_I8");
        return;
    }

    pdscal_(&n4, ALPHA, X, &ix4, &jx4, descx4, &incx4);
}
