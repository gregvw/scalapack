...
*  =======
*
*  PB_Cpsyr  performs a symmetric or Hermitian rank-k update of the sub-
...
*
*  SYR     (local input) pointer to function of type TZSYR_T
*          On entry, SYR specifies the function performing the update of
*          a single block.
*
...
*/
   ...
   {
      SYR( TYPE, UPLO, Amp, Anq, K, 0, ALPHA, XC, LDXC, XR, LDXR, Mptr( A, Aii,
           Ajj, Ald, size ), Ald );
      return;
   }
