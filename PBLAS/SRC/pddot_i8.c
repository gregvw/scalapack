/*
 * pddot_i8.c -- I8 entry point for PDDOT.
 */

#include "pblas_i8_utils.h"

extern void pddot_(Int *, double *,
                   double *, Int *, Int *, Int *, Int *,
                   double *, Int *, Int *, Int *, Int *);

void pddot_i8_(int64_t *N, double *DOT,
               ...
               int64_t *INCY)
{
    ...
    {
        pblas_i8_abort((Int)DESCX[1], "PDDOT_I8");
        return;
    }
