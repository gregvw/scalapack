/*
 * pdgemv_i8.c -- I8 entry point for PDGEMV.
 */

#include "pblas_i8_utils.h"
#include "PBblas.h"

extern void pdgemv_(F_CHAR_T, Int *, Int *, double *,
                    double *, Int *, Int *, Int *,
                    double *, Int *, Int *, Int *, Int *,
                    double *,
                    double *, Int *, Int *, Int *, Int *);

void pdgemv_i8_(F_CHAR_T TRANS, int64_t *M, int64_t *N, double *ALPHA,
                ...
                int64_t *INCY)
{
    ...
    {
        pblas_i8_abort((Int)DESCA[1], "PDGEMV_I8");
        return;
    }

    pdgemv_(TRANS, &m4, &n4, ALPHA,
            A, &ia4, &ja4, desca4,
