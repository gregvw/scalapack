...
*/
   ...
   {
      PB_Cchkvec( ctxt, "PZSWAP", "X", *N, 1, Xi, Xj, Xd, *INCX,  5, &info );
      PB_Cchkvec( ctxt, "PZSWAP", "Y", *N, 1, Yi, Yj, Yd, *INCY, 10, &info );
   }
   if( info ) { PB_Cabort( ctxt, "PZSWAP", info ); return; }
#endif
/*
...
*/
            if( XmyprocR == XprocR )
            {
               ...
               if( XnpD > 0 )
               {
                  ...
                  if( XisRow )
                  {
                     Czgesd2d( ctxt, 1, XnpD, Mptr( ((char*) X), Xii, Xjj,
                               Xld, size ), Xld, YprocR, dst );
                     Czgerv2d( ctxt, 1, XnpD, Mptr( ((char*) X), Xii, Xjj,
                               Xld, size ), Xld, YprocR, dst );
                  }
                  else
                  {

                     Czgesd2d( ctxt, XnpD, 1, Mptr( ((char*) X), Xii, Xjj,
                               Xld, size ), Xld, dst, YprocR );
                     Czgerv2d( ctxt, XnpD, 1, Mptr( ((char*) X), Xii, Xjj,
                               Xld, size ), Xld, dst, YprocR );
                  }
               }
            }
            if( YmyprocR == YprocR )
            {
               ...
               if( YnpD > 0 )
               {
                  ...
                  if( YisRow )
                  {
                     ...
                     Czgerv2d( ctxt, 1, YnpD, Mptr( ((char*) Y), Yii, Yjj,
                               Yld, size ), Yld, XprocR, dst );
                  }
                  else
                  {
                     ...
                     Czgerv2d( ctxt, YnpD, 1, Mptr( ((char*) Y), Yii, Yjj,
                               Yld, size ), Yld, dst, XprocR );
                  }
               }
            }
...
*/
               ...
               if( XnpD > 0 )
               {
                  ...
                  {
                     zswap_( &XnpD,  Mptr( ((char *) X), Xii, Xjj, Xld,
                  ...
                  {
                     if( XisRow )
                        Czgesd2d( ctxt, 1, XnpD, Mptr( ((char *) X), Xii,
                                  Xjj, Xld, size ), Xld, rdst, cdst );
                     else
                        Czgesd2d( ctxt, XnpD, 1, Mptr( ((char *) X), Xii,
                                  Xjj, Xld, size ), Xld, rdst, cdst );
                  }
               }
            }
               ...
               if( YnpD > 0 )
               {
                  ...
                  if( ( myrow != rsrc ) || ( mycol != csrc ) )
                  {
                     if( !PB_CSizeMul2( YnpD, size, &alloc_bytes ) )
                        PB_Cabort( ctxt, "PZSWAP", -1 );
                     buf = PB_Cmalloc64( alloc_bytes );
                     if( XisRow )
                        Czgerv2d( ctxt, 1, YnpD, buf,    1, rsrc, csrc );
                     else
                        Czgerv2d( ctxt, YnpD, 1, buf, YnpD, rsrc, csrc );
                     if( YisRow )
                        Czgesd2d( ctxt, 1, YnpD, Mptr( ((char *) Y), Yii,
                                  Yjj, Yld, size ), Yld, rsrc, csrc );
                     else
                        Czgesd2d( ctxt, YnpD, 1, Mptr( ((char *) Y), Yii,
                                  Yjj, Yld, size ), Yld, rsrc, csrc );
                     zcopy_( &YnpD, buf, &ione, Mptr( ((char *) Y), Yii,
                             Yjj, Yld, size ), &Ylinc );
                     if( buf ) free( buf );
                  }
               }
...
*/
               if( XnpD > 0 )
               {
                  if( ( myrow != rdst ) || ( mycol != cdst ) )
                  {
                     ...
                     buf = PB_Cmalloc64( alloc_bytes );
                     if( YisRow )
                        Czgerv2d( ctxt, 1, XnpD, buf,    1, rdst, cdst );
                     else
                        Czgerv2d( ctxt, XnpD, 1, buf, XnpD, rdst, cdst );
                     zcopy_( &XnpD, buf, &ione, Mptr( ((char *) X), Xii,
                             Xjj, Xld, size ), &Xlinc );
                     if( buf ) free( buf );
                  }
               }
...
*/
                        if( ( XmyprocR == XprocR ) && ( XmyprocD == Xroc ) )
                        {
                           ...
                           Czgesd2d( ctxt, Xm, Xn, buf, Xm, rdst, cdst );
                           Czgerv2d( ctxt, Ym, Yn, buf, Ym, rdst, cdst );
                        ...
                        if( ( YmyprocR == YprocR ) && ( YmyprocD == Yroc  ) )
                        {
                           ...
                           PB_CVMpack( type, &VM, COLUMN, &Yscope, PACKING,
                                       ...
                                       Ym );
                           Czgesd2d( ctxt, Ym, Yn, buf, Ym, rsrc, csrc );
                           Czgerv2d( ctxt, Xm, Xn, buf, Xm, rsrc, csrc );
...
*/
         ...
         if( XnpD > 0 )
         {
            if( XisRow )
            {
               ...
               if( XmyprocR == XprocR )
                  Czgebs2d( ctxt, COLUMN, top, 1, XnpD, Mptr( ((char *) X),
                            Xii, Xjj, Xld, size ), Xld );
               else
                  Czgebr2d( ctxt, COLUMN, top, 1, XnpD, Mptr( ((char *) X),
            ...
            else
            {
               ...
               if( XmyprocR == XprocR )
                  Czgebs2d( ctxt, ROW,    top, XnpD, 1, Mptr( ((char *) X),
                            Xii, Xjj, Xld, size ), Xld );
               else
                  Czgebr2d( ctxt, ROW,    top, XnpD, 1, Mptr( ((char *) X),
...
*/
         ...
         if( YnpD > 0 )
         {
            if( YisRow )
            {
               top = PB_Ctop( &ctxt, BCAST, COLUMN, TOP_GET );
               if( YmyprocR == YprocR )
                  Czgebs2d( ctxt, COLUMN, top, 1, YnpD, Mptr( ((char *) Y),
                            Yii, Yjj, Yld, size ), Yld );
               else
                  Czgebr2d( ctxt, COLUMN, top, 1, YnpD, Mptr( ((char *) Y),
            ...
            else
            {
               top = PB_Ctop( &ctxt, BCAST, ROW,    TOP_GET );
               if( YmyprocR == YprocR )
                  Czgebs2d( ctxt, ROW,    top, YnpD, 1, Mptr( ((char *) Y),
                            Yii, Yjj, Yld, size ), Yld );
               else
                  Czgebr2d( ctxt, ROW,    top, YnpD, 1, Mptr( ((char *) Y),
...
*/
      PB_CpswapND( PB_Cztypeset(), *N, ((char *) X), Xi, Xj, Xd, *INCX,
...
*/
      PB_CpswapND( PB_Cztypeset(), *N, ((char *) Y), Yi, Yj, Yd, *INCY,
...
*/
      PB_CpswapNN( PB_Cztypeset(), *N, ((char *) X), Xi, Xj, Xd, *INCX,
                   ((char *) Y), Yi, Yj, Yd, *INCY );
   }
/*
*  End of PZSWAP
