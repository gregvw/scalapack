...
*/
   ...
   {
      PB_Cchkvec( ctxt, "PCSWAP", "X", *N, 1, Xi, Xj, Xd, *INCX,  5, &info );
      PB_Cchkvec( ctxt, "PCSWAP", "Y", *N, 1, Yi, Yj, Yd, *INCY, 10, &info );
   }
   if( info ) { PB_Cabort( ctxt, "PCSWAP", info ); return; }
#endif
/*
...
*/
            if( XmyprocR == XprocR )
            {
               ...
               if( XnpD > 0 )
               {
                  ...
                  if( XisRow )
                  {
                     Ccgesd2d( ctxt, 1, XnpD, Mptr( ((char*) X), Xii, Xjj,
                               Xld, size ), Xld, YprocR, dst );
                     Ccgerv2d( ctxt, 1, XnpD, Mptr( ((char*) X), Xii, Xjj,
                               Xld, size ), Xld, YprocR, dst );
                  }
                  else
                  {

                     Ccgesd2d( ctxt, XnpD, 1, Mptr( ((char*) X), Xii, Xjj,
                               Xld, size ), Xld, dst, YprocR );
                     Ccgerv2d( ctxt, XnpD, 1, Mptr( ((char*) X), Xii, Xjj,
                               Xld, size ), Xld, dst, YprocR );
                  }
               }
            }
            if( YmyprocR == YprocR )
            {
               ...
               if( YnpD > 0 )
               {
                  ...
                  if( YisRow )
                  {
                     ...
                     Ccgerv2d( ctxt, 1, YnpD, Mptr( ((char*) Y), Yii, Yjj,
                               Yld, size ), Yld, XprocR, dst );
                  }
                  else
                  {
                     ...
                     Ccgerv2d( ctxt, YnpD, 1, Mptr( ((char*) Y), Yii, Yjj,
                               Yld, size ), Yld, dst, XprocR );
                  }
               }
            }
...
*/
               ...
               if( XnpD > 0 )
               {
                  ...
                  {
                     cswap_( &XnpD,  Mptr( ((char *) X), Xii, Xjj, Xld,
                  ...
                  {
                     if( XisRow )
                        Ccgesd2d( ctxt, 1, XnpD, Mptr( ((char *) X), Xii,
                                  Xjj, Xld, size ), Xld, rdst, cdst );
                     else
                        Ccgesd2d( ctxt, XnpD, 1, Mptr( ((char *) X), Xii,
                                  Xjj, Xld, size ), Xld, rdst, cdst );
                  }
               }
            }
               ...
               if( YnpD > 0 )
               {
                  ...
                  if( ( myrow != rsrc ) || ( mycol != csrc ) )
                  {
                     if( !PB_CSizeMul2( YnpD, size, &alloc_bytes ) )
                        PB_Cabort( ctxt, "PCSWAP", -1 );
                     buf = PB_Cmalloc64( alloc_bytes );
                     if( XisRow )
                        Ccgerv2d( ctxt, 1, YnpD, buf,    1, rsrc, csrc );
                     else
                        Ccgerv2d( ctxt, YnpD, 1, buf, YnpD, rsrc, csrc );
                     if( YisRow )
                        Ccgesd2d( ctxt, 1, YnpD, Mptr( ((char *) Y), Yii,
                                  Yjj, Yld, size ), Yld, rsrc, csrc );
                     else
                        Ccgesd2d( ctxt, YnpD, 1, Mptr( ((char *) Y), Yii,
                                  Yjj, Yld, size ), Yld, rsrc, csrc );
                     ccopy_( &YnpD, buf, &ione, Mptr( ((char *) Y), Yii,
                             Yjj, Yld, size ), &Ylinc );
                     if( buf ) free( buf );
                  }
               }
...
*/
               if( XnpD > 0 )
               {
                  if( ( myrow != rdst ) || ( mycol != cdst ) )
                  {
                     ...
                     buf = PB_Cmalloc64( alloc_bytes );
                     if( YisRow )
                        Ccgerv2d( ctxt, 1, XnpD, buf,    1, rdst, cdst );
                     else
                        Ccgerv2d( ctxt, XnpD, 1, buf, XnpD, rdst, cdst );
                     ccopy_( &XnpD, buf, &ione, Mptr( ((char *) X), Xii,
                             Xjj, Xld, size ), &Xlinc );
                     if( buf ) free( buf );
                  }
               }
...
*/
                        if( ( XmyprocR == XprocR ) && ( XmyprocD == Xroc ) )
                        {
                           ...
                           Ccgesd2d( ctxt, Xm, Xn, buf, Xm, rdst, cdst );
                           Ccgerv2d( ctxt, Ym, Yn, buf, Ym, rdst, cdst );
                        ...
                        if( ( YmyprocR == YprocR ) && ( YmyprocD == Yroc  ) )
                        {
                           ...
                           PB_CVMpack( type, &VM, COLUMN, &Yscope, PACKING,
                                       ...
                                       Ym );
                           Ccgesd2d( ctxt, Ym, Yn, buf, Ym, rsrc, csrc );
                           Ccgerv2d( ctxt, Xm, Xn, buf, Xm, rsrc, csrc );
...
*/
         ...
         if( XnpD > 0 )
         {
            if( XisRow )
            {
               ...
               if( XmyprocR == XprocR )
                  Ccgebs2d( ctxt, COLUMN, top, 1, XnpD, Mptr( ((char *) X),
                            Xii, Xjj, Xld, size ), Xld );
               else
                  Ccgebr2d( ctxt, COLUMN, top, 1, XnpD, Mptr( ((char *) X),
            ...
            else
            {
               ...
               if( XmyprocR == XprocR )
                  Ccgebs2d( ctxt, ROW,    top, XnpD, 1, Mptr( ((char *) X),
                            Xii, Xjj, Xld, size ), Xld );
               else
                  Ccgebr2d( ctxt, ROW,    top, XnpD, 1, Mptr( ((char *) X),
...
*/
         ...
         if( YnpD > 0 )
         {
            if( YisRow )
            {
               top = PB_Ctop( &ctxt, BCAST, COLUMN, TOP_GET );
               if( YmyprocR == YprocR )
                  Ccgebs2d( ctxt, COLUMN, top, 1, YnpD, Mptr( ((char *) Y),
                            Yii, Yjj, Yld, size ), Yld );
               else
                  Ccgebr2d( ctxt, COLUMN, top, 1, YnpD, Mptr( ((char *) Y),
            ...
            else
            {
               top = PB_Ctop( &ctxt, BCAST, ROW,    TOP_GET );
               if( YmyprocR == YprocR )
                  Ccgebs2d( ctxt, ROW,    top, YnpD, 1, Mptr( ((char *) Y),
                            Yii, Yjj, Yld, size ), Yld );
               else
                  Ccgebr2d( ctxt, ROW,    top, YnpD, 1, Mptr( ((char *) Y),
...
*/
      PB_CpswapND( PB_Cctypeset(), *N, ((char *) X), Xi, Xj, Xd, *INCX,
...
*/
      PB_CpswapND( PB_Cctypeset(), *N, ((char *) Y), Yi, Yj, Yd, *INCY,
...
*/
      PB_CpswapNN( PB_Cctypeset(), *N, ((char *) X), Xi, Xj, Xd, *INCX,
                   ((char *) Y), Yi, Yj, Yd, *INCY );
   }
/*
*  End of PCSWAP
