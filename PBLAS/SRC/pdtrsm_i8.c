/*
 * pdtrsm_i8.c -- I8 entry point for PDTRSM.
 */
#include "pblas_i8_utils.h"
#include "PBblas.h"

extern void pdtrsm_(F_CHAR_T, F_CHAR_T, F_CHAR_T, F_CHAR_T,
                     Int *, Int *, double *,
                     double *, Int *, Int *, Int *,
                     double *, Int *, Int *, Int *);

void pdtrsm_i8_(F_CHAR_T SIDE, F_CHAR_T UPLO, F_CHAR_T TRANS, F_CHAR_T DIAG,
                 ...
                 double *B, int64_t *IB, int64_t *JB, int64_t *DESCB)
{
    ...
    {
        pblas_i8_abort((Int)DESCA[1], "PDTRSM_I8");
        return;
    }

    pdtrsm_(SIDE, UPLO, TRANS, DIAG, &m4, &n4, ALPHA,
            A, &ia4, &ja4, desca4,
            B, &ib4, &jb4, descb4);
}
