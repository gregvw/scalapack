/*
 * pcgeru_i8.c -- I8 entry point for PCGERU.
 */
#include "pblas_i8_utils.h"
#include "PBblas.h"

extern void pcgeru_(Int *, Int *, float *,
                    float *, Int *, Int *, Int *, Int *,
                    float *, Int *, Int *, Int *, Int *,
                    float *, Int *, Int *, Int *);

void pcgeru_i8_(int64_t *M, int64_t *N, float *ALPHA,
                ...
                float *A, int64_t *IA, int64_t *JA, int64_t *DESCA)
{
    ...
    {
        pblas_i8_abort((Int)DESCA[1], "PCGERU_I8");
        return;
    }
