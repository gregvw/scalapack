/*
 * pssyrk_i8.c -- I8 entry point for PSSYRK.
 */
#include "pblas_i8_utils.h"
#include "PBblas.h"

extern void pssyrk_(F_CHAR_T, F_CHAR_T, Int *, Int *, float *,
                     float *, Int *, Int *, Int *,
                     float *,
                     float *, Int *, Int *, Int *);

void pssyrk_i8_(F_CHAR_T UPLO, F_CHAR_T TRANS,
                 ...
                 float *C, int64_t *IC, int64_t *JC, int64_t *DESCC)
{
    ...
    {
        pblas_i8_abort((Int)DESCA[1], "PSSYRK_I8");
        return;
    }

    pssyrk_(UPLO, TRANS, &n4, &k4, ALPHA,
            A, &ia4, &ja4, desca4,
            BETA,
            C, &ic4, &jc4, descc4);
}
