/*
 * pdnrm2_i8.c -- I8 entry point for PDNRM2.
 */

#include "pblas_i8_utils.h"

extern void pdnrm2_(Int *, double *,
                    double *, Int *, Int *, Int *, Int *);

void pdnrm2_i8_(int64_t *N, double *NORM2,
                ...
                int64_t *INCX)
{
    ...
    {
        pblas_i8_abort((Int)DESCX[1], "PDNRM2_I8");
        return;
    }

    pdnrm2_(&n4, NORM2, X, &ix4, &jx4, descx4, &incx4);
}
