/*
 * pzamax_i8.c -- I8 entry point for PZAMAX.
 */
#include "pblas_i8_utils.h"
#include "PBblas.h"

extern void pzamax_(Int *, double *, Int *,
                    double *, Int *, Int *, Int *, Int *);

void pzamax_i8_(int64_t *N, double *AMAX, Int *INDX,
                ...
                int64_t *INCX)
{
    ...
    {
        pblas_i8_abort((Int)DESCX[1], "PZAMAX_I8");
        return;
    }

    pzamax_(&n4, AMAX, INDX,
