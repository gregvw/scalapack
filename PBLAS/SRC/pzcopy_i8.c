/*
 * pzcopy_i8.c — I8 entry point for PZCOPY.
 *
 * Takes int64_t arguments from Fortran INTEGER*8 callers, narrows
 * to Int with overflow checks, and delegates to the legacy pzcopy_.
 */

#include "pblas_i8_utils.h"

/* Legacy entry point */
extern void pzcopy_(Int *,
                    double *, Int *, Int *, Int *, Int *,
                    double *, Int *, Int *, Int *, Int *);

void pzcopy_i8_(int64_t *N,
                ...
                int64_t *INCY)
{
    ...
    {
        pblas_i8_abort((Int)DESCX[1], "PZCOPY_I8");
        return;
    }
