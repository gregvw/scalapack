/*
 * psgemv_i8.c -- I8 entry point for PSGEMV.
 */

#include "pblas_i8_utils.h"
#include "PBblas.h"

extern void psgemv_(F_CHAR_T, Int *, Int *, float *,
                    float *, Int *, Int *, Int *,
                    float *, Int *, Int *, Int *, Int *,
                    float *,
                    float *, Int *, Int *, Int *, Int *);

void psgemv_i8_(F_CHAR_T TRANS, int64_t *M, int64_t *N, float *ALPHA,
                ...
                int64_t *INCY)
{
    ...
    {
        pblas_i8_abort((Int)DESCA[1], "PSGEMV_I8");
        return;
    }

    psgemv_(TRANS, &m4, &n4, ALPHA,
            A, &ia4, &ja4, desca4,
