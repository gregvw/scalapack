/*
 * pcgemm_i8.c -- I8 entry point for PCGEMM.
 */
#include "pblas_i8_utils.h"
#include "PBblas.h"

extern void pcgemm_(F_CHAR_T, F_CHAR_T, Int *, Int *, Int *, float *,
                    float *, Int *, Int *, Int *,
                    float *, Int *, Int *, Int *,
                    float *,
                    float *, Int *, Int *, Int *);

void pcgemm_i8_(F_CHAR_T TRANSA, F_CHAR_T TRANSB,
                ...
                float *C, int64_t *IC, int64_t *JC, int64_t *DESCC)
{
    ...
    {
        pblas_i8_abort((Int)DESCA[1], "PCGEMM_I8");
        return;
    }

    pcgemm_(TRANSA, TRANSB, &m4, &n4, &k4, ALPHA,
            A, &ia4, &ja4, desca4,
            B, &ib4, &jb4, descb4,
            BETA,
            C, &ic4, &jc4, descc4);
