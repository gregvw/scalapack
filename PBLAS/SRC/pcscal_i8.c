/*
 * pcscal_i8.c — I8 entry point for PCSCAL.
 */

#include "pblas_i8_utils.h"

extern void pcscal_(Int *, float *,
                    float *, Int *, Int *, Int *, Int *);

void pcscal_i8_(int64_t *N, float *ALPHA,
                ...
                int64_t *INCX)
{
    ...
    {
        pblas_i8_abort((Int)DESCX[1], "PCSCAL_I8");
        return;
    }

    pcscal_(&n4, ALPHA, X, &ix4, &jx4, descx4, &incx4);
}
