/*
 * pchemv_i8.c -- I8 entry point for PCHEMV.
 */

#include "pblas_i8_utils.h"
#include "PBblas.h"

extern void pchemv_(F_CHAR_T, Int *, float *,
                    float *, Int *, Int *, Int *,
                    float *, Int *, Int *, Int *, Int *,
                    float *,
                    float *, Int *, Int *, Int *, Int *);

void pchemv_i8_(F_CHAR_T UPLO, int64_t *N, float *ALPHA,
                ...
                int64_t *INCY)
{
    ...
    {
        pblas_i8_abort((Int)DESCA[1], "PCHEMV_I8");
        return;
    }

    pchemv_(UPLO, &n4, ALPHA,
            A, &ia4, &ja4, desca4,
