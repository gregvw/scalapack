/*
 * pstrsm_i8.c -- I8 entry point for PSTRSM.
 */
#include "pblas_i8_utils.h"
#include "PBblas.h"

extern void pstrsm_(F_CHAR_T, F_CHAR_T, F_CHAR_T, F_CHAR_T,
                     Int *, Int *, float *,
                     float *, Int *, Int *, Int *,
                     float *, Int *, Int *, Int *);

void pstrsm_i8_(F_CHAR_T SIDE, F_CHAR_T UPLO, F_CHAR_T TRANS, F_CHAR_T DIAG,
                 ...
                 float *B, int64_t *IB, int64_t *JB, int64_t *DESCB)
{
    ...
    {
        pblas_i8_abort((Int)DESCA[1], "PSTRSM_I8");
        return;
    }

    pstrsm_(SIDE, UPLO, TRANS, DIAG, &m4, &n4, ALPHA,
            A, &ia4, &ja4, desca4,
            B, &ib4, &jb4, descb4);
}
