/*
 * pdsymv_i8.c -- I8 entry point for PDSYMV.
 */

#include "pblas_i8_utils.h"
#include "PBblas.h"

extern void pdsymv_(F_CHAR_T, Int *, double *,
                    double *, Int *, Int *, Int *,
                    double *, Int *, Int *, Int *, Int *,
                    double *,
                    double *, Int *, Int *, Int *, Int *);

void pdsymv_i8_(F_CHAR_T UPLO, int64_t *N, double *ALPHA,
                ...
                int64_t *INCY)
{
    ...
    {
        pblas_i8_abort((Int)DESCA[1], "PDSYMV_I8");
        return;
    }

    pdsymv_(UPLO, &n4, ALPHA,
            A, &ia4, &ja4, desca4,
