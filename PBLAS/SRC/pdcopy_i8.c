/*
 * pdcopy_i8.c — I8 entry point for PDCOPY.
 *
 * Takes int64_t arguments from Fortran INTEGER*8 callers, narrows
 * to Int with overflow checks, and delegates to the legacy pdcopy_.
 */

#include "pblas_i8_utils.h"

/* Legacy entry point */
extern void pdcopy_(Int *,
                    double *, Int *, Int *, Int *, Int *,
                    double *, Int *, Int *, Int *, Int *);

void pdcopy_i8_(int64_t *N,
                ...
                int64_t *INCY)
{
    ...
    {
        pblas_i8_abort((Int)DESCX[1], "PDCOPY_I8");
        return;
    }
