/*
 * pcdotc_i8.c -- I8 entry point for PCDOTC (conjugate dot product).
 */

#include "pblas_i8_utils.h"

extern void pcdotc_(Int *, float *,
                    float *, Int *, Int *, Int *, Int *,
                    float *, Int *, Int *, Int *, Int *);

void pcdotc_i8_(int64_t *N, float *DOT,
                ...
                int64_t *INCY)
{
    ...
    {
        pblas_i8_abort((Int)DESCX[1], "PCDOTC_I8");
        return;
    }
