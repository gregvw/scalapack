/*
 * pssyr2k_i8.c -- I8 entry point for PSSYR2K.
 */
#include "pblas_i8_utils.h"
#include "PBblas.h"

extern void pssyr2k_(F_CHAR_T, F_CHAR_T, Int *, Int *, float *,
                     float *, Int *, Int *, Int *,
                     float *, Int *, Int *, Int *,
                     float *,
                     float *, Int *, Int *, Int *);

void pssyr2k_i8_(F_CHAR_T UPLO, F_CHAR_T TRANS,
                 ...
                 float *C, int64_t *IC, int64_t *JC, int64_t *DESCC)
{
    ...
    {
        pblas_i8_abort((Int)DESCA[1], "PSSYR2K_I8");
        return;
    }

    pssyr2k_(UPLO, TRANS, &n4, &k4, ALPHA,
             A, &ia4, &ja4, desca4,
             B, &ib4, &jb4, descb4,
             BETA,
             C, &ic4, &jc4, descc4);
