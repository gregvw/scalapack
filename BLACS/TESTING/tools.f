*  ================================================================
*  Random-number generators for the BLACS tester: DLARND, ZLARND,
*  DLARAN.  LAPACK utilities (LSAME, SLAMCH, DLAMCH, etc.) that
*  were formerly bundled here are now resolved from BLAS/LAPACK
*  at link time.
*  ================================================================
