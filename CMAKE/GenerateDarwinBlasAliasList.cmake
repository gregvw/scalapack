...
foreach(_scalapack_line IN LISTS _scalapack_nm_lines)
  ...
  string(REGEX MATCH "(_[a-z0-9]+_)$" _scalapack_plain_symbol_match "${_scalapack_line}")
  if(_scalapack_plain_symbol_match)
    list(APPEND _scalapack_exported_symbols "${CMAKE_MATCH_1}")
  endif()

  string(REGEX MATCH "(_[a-z0-9]+_64_)$" _scalapack_suffix64_symbol_match "${_scalapack_line}")
